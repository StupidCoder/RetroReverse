...
// Interactive Multiplayer discs. Like tools/platform/psx it is built in layers:
//
...
//   - machine.go  is the boot oracle: an ARM60 (tools/cpu/arm60) wired to the 3DO
...
// sibling package tools/cpu/arm60. Everything here is derived from the disc and from
